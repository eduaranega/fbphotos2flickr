...
public class MainActivity extends FragmentActivity {
	...
	private static final int FBLOGOUT = 2;
	private static final int FRAGMENT_COUNT = FBLOGOUT +1;
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    fragments[FBLOGOUT] = fm.findFragmentById(R.id.userSettingsFragment);
	    					...
	    					new Request.GraphUserCallback() {
	    						...
	    						public void onCompleted(GraphUser user,Response response) {
	    							if (user != null) { 
	    								...
	    								Log.d(TAG,"Email "+ user.asMap().get("email"));
	    							}
	    						}
	    				});
	    		}
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
	    ...
	    if (fragments[SELECTION].isVisible()) {
	        if (menu.size() == 0) {
	            settings = menu.add(R.string.fblogout);
	        }
	        return true;
	    } else {
	        menu.clear();
